...
export default function MobileAdminLayout({
        ...
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-grow container py-8">
                ...
                <p className="text-muted-foreground mt-1">
                    No tienes permisos de informante para acceder a esta sección.
                </p>
            </main>
  ...
  // Render mobile admin content if authorized
  return (
    <div className="flex flex-col min-h-screen">
      <Header />
      <main className="flex-grow container py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-headline font-bold">
            Portal de Informantes
          </h1>
          <p className="text-muted-foreground mt-1">
            Actualización rápida de precios y productos.
          </p>
        </div>
        {children}
      </main>
